...
from .serializers import KeyboardSerializer, MouseSerializer, DisplaySerializer, SpeakerSerializer, MotherboardSerializer, ProcessorSerializer, ComputerSerializer, OrderSerializer
